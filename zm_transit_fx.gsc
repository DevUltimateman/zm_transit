...
main()
{
    //replacefunc( maps\mp\zm_transit_fx::main, ::main_custom );
    replacefunc( maps\mp\zm_transit_fx::precache_scripted_fx, ::precache_scripted_fx_mods );
    replacefunc( maps\mp\zm_transit_fx::precache_createfx_fx, ::precache_createfx_fx_mods );
}

main_custom()
{
    //maps\mp\zm_transit_fx::precache_createfx_fx();
    //maps\mp\zm_transit_fx::precache_scripted_fx();
    iprintln( "WE SKIPPED LEVEL EFFECTS" );
}
precache_scripted_fx_mods()
{
...
precache_createfx_fx_mods()
{
    ...
    level._effect["fx_zmb_fog_closet"] = loadfx( "bio/insects/fx_insects_swarm_md_light" );
    level._effect["fx_zmb_fog_low_300x300"] = loadfx( "bio/insects/fx_insects_swarm_md_light" );
    level._effect["fx_zmb_fog_thick_600x600"] = loadfx( "bio/insects/fx_insects_swarm_md_light" );
    level._effect["fx_zmb_fog_thick_1200x600"] = loadfx( "bio/insects/fx_insects_swarm_md_light" );
    level._effect["fx_zmb_fog_transition_600x600"] = loadfx( "bio/insects/fx_insects_swarm_md_light" );
    level._effect["fx_zmb_fog_transition_1200x600"] = loadfx( "bio/insects/fx_insects_swarm_md_light" );
