...
CoD.Zombie.GameOptions[2].labels[2] = "15"
CoD.Zombie.GameOptions[2].labels[3] = "110"
CoD.Zombie.GameOptions[2].labels[4] = "115"
CoD.Zombie.GameOptions[2].labels[5] = "210"
CoD.Zombie.GameOptions[2].values = {}
CoD.Zombie.GameOptions[2].values[1] = 1
CoD.Zombie.GameOptions[2].values[2] = 15
CoD.Zombie.GameOptions[2].values[3] = 110
CoD.Zombie.GameOptions[2].values[4] = 115
CoD.Zombie.GameOptions[2].values[5] = 210
